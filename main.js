...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html, body {\n  margin: 0px;\n  height: 100%; }\n\n.main-container-default, .main-container-clear, .main-container-cloudy, .main-container-snowy, .main-container-atmos, .main-container-rain, .main-container-thunderstorm {\n  box-sizing: border-box;\n  height: 100%;\n  display: grid;\n  grid-template-columns: 2fr 1fr 1fr 2fr;\n  grid-template-rows: 1fr 2fr 1fr; }\n\n.main-container-default {\n  background: #cccccc;\n  color: #2b2b2b; }\n\n.main-container-clear {\n  background: -webkit-linear-gradient(top, #1452af, #3186cc, #b4e1ff);\n  background: -moz-linear-gradient(top, #1452af, #3186cc, #b4e1ff);\n  background: -o-linear-gradient(top, #1452af, #3186cc, #b4e1ff);\n  background: linear-gradient(top, #1452af, #3186cc, #b4e1ff);\n  color: white; }\n\n.main-container-cloudy {\n  background: -webkit-linear-gradient(top, #5988af, #555555);\n  background: -moz-linear-gradient(top, #5988af, #555555);\n  background: -o-linear-gradient(top, #5988af, #555555);\n  background: linear-gradient(top, #5988af, #555555);\n  color: #d4d4d4; }\n\n.main-container-snowy {\n  background: -webkit-linear-gradient(top, #b4e1ff, #ecf8ff, white);\n  background: -moz-linear-gradient(top, #b4e1ff, #ecf8ff, white);\n  background: -o-linear-gradient(top, #b4e1ff, #ecf8ff, white);\n  background: linear-gradient(top, #b4e1ff, #ecf8ff, white);\n  color: #46748f; }\n\n.main-container-atmos {\n  background: -webkit-linear-gradient(top, #795d57, #3f3330);\n  background: -moz-linear-gradient(top, #795d57, #3f3330);\n  background: -o-linear-gradient(top, #795d57, #3f3330);\n  background: linear-gradient(top, #795d57, #3f3330);\n  color: #c7c7c7; }\n\n.main-container-rain {\n  background: -webkit-linear-gradient(top, #2f2d3a, #464d46);\n  background: -moz-linear-gradient(top, #2f2d3a, #464d46);\n  background: -o-linear-gradient(top, #2f2d3a, #464d46);\n  background: linear-gradient(top, #2f2d3a, #464d46);\n  color: #b6b6b6; }\n\n.main-container-thunderstorm {\n  background: -webkit-linear-gradient(top, #1f162b, #463f52);\n  background: -moz-linear-gradient(top, #1f162b, #463f52);\n  background: -o-linear-gradient(top, #1f162b, #463f52);\n  background: linear-gradient(top, #1f162b, #463f52);\n  color: #fffec4; }\n\n#weather-container {\n  grid-column: 2/4;\n  grid-row: 2/3;\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 7fr 1fr;\n  font-family: \"Karla\", sans-serif;\n  font-size: 1.8rem; }\n\n#left-container {\n  grid-row: 2/3; }\n\n#right-container {\n  grid-row: 1/4;\n  display: grid;\n  justify-items: end; }\n\n#name {\n  font-size: 4rem; }\n\n#desc, #feels-like {\n  font-size: 2.5rem; }\n\n#temp {\n  font-size: 8rem; }\n\n#unit {\n  margin-top: 3rem;\n  font-size: 2rem; }\n\n#unit:hover {\n  color: white; }\n\n#humidity, #wind-speed, #chance-of-rain, #sunrise {\n  margin-bottom: 1rem; }\n\n#form-container {\n  grid-row: 3/4;\n  grid-column: 2/4;\n  font-family: \"Karla\", sans-serif; }\n\n#form-input {\n  width: 16rem;\n  height: 2rem;\n  font-size: 1rem;\n  font-family: \"Karla\", sans-serif;\n  background: rgba(255, 255, 255, 0.5);\n  border: solid white 1px; }\n\n#submit-btn {\n  margin-left: 1rem;\n  font-size: 1rem;\n  padding: 0.5rem;\n  border: solid white 1px;\n  font-family: \"Karla\", sans-serif; }\n\n#form-input:focus, #submit-btn:focus {\n  outline: none; }\n\n#submit-btn:hover {\n  background: #2c2c2c;\n  color: white; }\n\n#alert-none {\n  display: none;\n  margin-top: 1rem;\n  font-size: 1.3rem; }\n\n#alert-block {\n  display: block;\n  margin-top: 1rem;\n  font-size: 1.3rem; }\n", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAgCA;EACE,WAAW;EACX,YAAY,EAAA;;AAGd;EACE,sBAAsB;EACtB,YAAY;EACZ,aAAa;EACb,sCAAsC;EACtC,+BAA+B,EAAA;;AAGjC;EAEE,mBAA8B;EAC9B,cAAsB,EAAA;;AAGxB;EAzBE,mEAAsD;EACtD,gEAAmD;EACnD,8DAAiD;EACjD,2DAA8C;EAyB9C,YAAY,EAAA;;AAGd;EA/BE,0DAAsD;EACtD,uDAAmD;EACnD,qDAAiD;EACjD,kDAA8C;EA+B9C,cAAyB,EAAA;;AAG3B;EArCE,iEAAsD;EACtD,8DAAmD;EACnD,4DAAiD;EACjD,yDAA8C;EAqC9C,cAAwB,EAAA;;AAG1B;EA3CE,0DAAsD;EACtD,uDAAmD;EACnD,qDAAiD;EACjD,kDAA8C;EA2C9C,cAAyB,EAAA;;AAG3B;EAjDE,0DAAsD;EACtD,uDAAmD;EACnD,qDAAiD;EACjD,kDAA8C;EAiD9C,cAAyB,EAAA;;AAG3B;EAvDE,0DAAsD;EACtD,uDAAmD;EACnD,qDAAiD;EACjD,kDAA8C;EAuD9C,cAAyB,EAAA;;AAG3B;EACE,gBAAgB;EAChB,aAAa;EACb,aAAa;EACb,8BAA8B;EAC9B,+BAA+B;EAC/B,gCA3FyB;EA4FzB,iBAAiB,EAAA;;AAGnB;EACE,aAAa,EAAA;;AAGf;EACE,aAAa;EACb,aAAa;EACb,kBAAkB,EAAA;;AAGpB;EACE,eAAe,EAAA;;AAGjB;EACE,iBAAiB,EAAA;;AAGnB;EACE,eAAe,EAAA;;AAGjB;EACE,gBAAgB;EAChB,eAAe,EAAA;;AAGjB;EACE,YAAY,EAAA;;AAGd;EACE,mBAAmB,EAAA;;AAGrB;EACE,aAAa;EACb,gBAAgB;EAChB,gCArIyB,EAAA;;AAwI3B;EACE,YAAY;EACZ,YAAY;EACZ,eAAe;EACf,gCA5IyB;EA6IzB,oCAA8B;EAC9B,uBAAuB,EAAA;;AAGzB;EACE,iBAAiB;EACjB,eAAe;EACf,eAAe;EACf,uBAAuB;EACvB,gCAtJyB,EAAA;;AAyJ3B;EACE,aAAa,EAAA;;AAGf;EACE,mBAA2B;EAC3B,YAAY,EAAA;;AAGd;EACE,aAAa;EACb,gBAAgB;EAChB,iBAAiB,EAAA;;AAGnB;EACE,cAAc;EACd,gBAAgB;EAChB,iBAAiB,EAAA","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Karla:wght@200&display=swap');\n\n$karla: 'Karla', sans-serif;\n$dark-blue: rgb(20, 82, 175);\n$med-blue: rgb(49, 134, 204);\n$light-blue: rgb(180, 225, 255);\n$very-light-blue: rgb(236, 248, 255);\n$blue-gray: rgb(89, 136, 175);\n$very-dark-gray: rgb(34, 34, 34);\n$dark-gray: rgb(85, 85, 85);\n$light-gray: rgb(139, 139, 139);\n$sand: rgb(121, 93, 87);\n$dark-sand: rgb(63, 51, 48);\n$dark-purple: rgb(31, 22, 43);\n$purple-gray: rgb(70, 63, 82);\n$dark-green: rgb(47, 45, 58);\n$med-green: rgb(70, 77, 70);\n\n$clear: $dark-blue, $med-blue, $light-blue;\n$clouds: $blue-gray, $dark-gray;\n$snow: $light-blue, $very-light-blue, white;\n$atmos: $sand, $dark-sand;\n$thunderstorm: $dark-purple, $purple-gray;\n$rain: $dark-green, $med-green;\n\n@mixin gradient($direction, $list) { \n  background: -webkit-linear-gradient($direction, $list);\n  background: -moz-linear-gradient($direction, $list);\n  background: -o-linear-gradient($direction, $list);\n  background: linear-gradient($direction, $list);  \n}\n\nhtml, body {\n  margin: 0px;\n  height: 100%;\n}\n\n%main-container {\n  box-sizing: border-box;\n  height: 100%;\n  display: grid;\n  grid-template-columns: 2fr 1fr 1fr 2fr;\n  grid-template-rows: 1fr 2fr 1fr;\n}\n\n.main-container-default {\n  @extend %main-container;\n  background: rgb(204, 204, 204);\n  color: rgb(43, 43, 43);\n}\n\n.main-container-clear {\n  @extend %main-container;\n  @include gradient(top, $clear);\n  color: white;\n}\n\n.main-container-cloudy {\n  @extend %main-container;\n  @include gradient(top, $clouds);\n  color: rgb(212, 212, 212);\n}\n\n.main-container-snowy {\n  @extend %main-container;\n  @include gradient(top, $snow);\n  color: rgb(70, 116, 143);\n}\n\n.main-container-atmos {\n  @extend %main-container;\n  @include gradient(top, $atmos);\n  color: rgb(199, 199, 199);\n}\n\n.main-container-rain {\n  @extend %main-container;\n  @include gradient(top, $rain);\n  color: rgb(182, 182, 182);\n}\n\n.main-container-thunderstorm {\n  @extend %main-container;\n  @include gradient(top, $thunderstorm);\n  color: rgb(255, 254, 196);\n}\n\n#weather-container {\n  grid-column: 2/4;\n  grid-row: 2/3;\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 7fr 1fr;\n  font-family: $karla;\n  font-size: 1.8rem;\n}\n\n#left-container {\n  grid-row: 2/3;\n}\n\n#right-container {\n  grid-row: 1/4;\n  display: grid;\n  justify-items: end;\n}\n\n#name {\n  font-size: 4rem;\n}\n\n#desc, #feels-like {\n  font-size: 2.5rem;\n}\n\n#temp {\n  font-size: 8rem;\n}\n\n#unit {\n  margin-top: 3rem;\n  font-size: 2rem;\n}\n\n#unit:hover {\n  color: white;\n}\n\n#humidity, #wind-speed, #chance-of-rain, #sunrise {\n  margin-bottom: 1rem;\n}\n\n#form-container {\n  grid-row: 3/4;\n  grid-column: 2/4;\n  font-family: $karla;\n}\n\n#form-input {\n  width: 16rem;\n  height: 2rem;\n  font-size: 1rem;\n  font-family: $karla;\n  background: rgba($color: white, $alpha: 0.5);\n  border: solid white 1px;\n}\n\n#submit-btn {\n  margin-left: 1rem;\n  font-size: 1rem;\n  padding: 0.5rem;\n  border: solid white 1px;\n  font-family: $karla;\n}\n\n#form-input:focus, #submit-btn:focus {\n  outline: none;\n}\n\n#submit-btn:hover {\n  background: rgb(44, 44, 44);\n  color: white;\n}\n\n#alert-none {\n  display: none;\n  margin-top: 1rem;\n  font-size: 1.3rem;\n}\n\n#alert-block {\n  display: block;\n  margin-top: 1rem;\n  font-size: 1.3rem;\n}"],"sourceRoot":""}]);
// Exports
...
function createWeatherElem(container, obj) {
  ...
  const windSpeedElem = (0,_dom_manipulation_helper__WEBPACK_IMPORTED_MODULE_0__.default)(rightContainer, 'div', '', 'wind-speed', obj.windSpeed);
  const chanceOfRainLabel = (0,_dom_manipulation_helper__WEBPACK_IMPORTED_MODULE_0__.default)(rightContainer, 'div', '', 'chance-of-rain-label', 'chance of rain');
  const chanceOfRainElem = (0,_dom_manipulation_helper__WEBPACK_IMPORTED_MODULE_0__.default)(rightContainer, 'div', '', 'chance-of-rain', obj.chanceOfRain);
  const sunriseLabel = (0,_dom_manipulation_helper__WEBPACK_IMPORTED_MODULE_0__.default)(rightContainer, 'div', '', 'sunrise-label', 'sunrise');
...
function createFormElem(container, weatherElemContainer) {
  const formContainer = (0,_dom_manipulation_helper__WEBPACK_IMPORTED_MODULE_0__.default)(container, 'form', '', 'form-container');
...
function createDOM() {
  ...
  const mainContainer = (0,_dom_manipulation_helper__WEBPACK_IMPORTED_MODULE_0__.default)(body, 'div', 'main-container-default', 'main-container');
